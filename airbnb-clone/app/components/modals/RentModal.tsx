...
const RentModal = () => {
  ...
  if (step == STEPS.IMAGES) {
    bodyContent = (
      <div className='flex flex-col gap-8'>
        <Heading title='Add photo of your place' subTitle="Show guests what your place looks like"/>
  ...
  return ( 
    <Modal isOpen={rentModal.isOpen} title="Airbnb your home!" body={bodyContent} onClose={rentModal.onClose}
    onSubmit={handleSubmit(onSubmit)} actionLabel={actionLabel} secondaryActionLabel={secondaryActionLabel}
